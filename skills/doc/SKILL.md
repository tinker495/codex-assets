...
1. Prefer visual review (layout, tables, diagrams).
   ...
   - Delegate PDF rendering quality checks to the `pdf` skill when deeper visual QA is needed.
...
## Cross-Skill Usage
- `pdf`: owns PDF rendering-focused visual QA patterns and defect checks.

...
| Model ID                 | Use for                                                                                                      |
| ------------------------ | ------------------------------------------------------------------------------------------------------------ |
| `gpt-5.5`                | Default text plus reasoning for most new apps, including for coding use-cases                                |
| `gpt-5.5-pro`            | Only when the user explicitly asks for maximum reasoning or quality; substantially slower and more expensive |
| `gpt-5.5-mini`           | Cheaper and faster reasoning with good quality, including for coding use-cases                               |

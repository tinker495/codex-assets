...
Prefer `ask-gemini` for ideation and broad design exploration; use `ask-claude` instead when the task needs tighter review-style analysis or focused critique.

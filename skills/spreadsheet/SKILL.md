...
- Delegate PDF rendering-focused defect checks to the `pdf` skill when deeper visual QA is needed.
...
## Cross-Skill Usage
- `pdf`: owns rendering-heavy visual QA standards once sheets are converted to PDF/images.
